...
conexion1=mysql.connector.connect(host="localhost", user="root", passwd="", database="especies")
cursor1=conexion1.cursor()
#cursor1.execute("INSERT INTO cat_especies (nombres) VALUES ('xd');")
#sql="INSERT INTO cat_especies (nombres) VALUES ('');"
sql="SELECT * FROM cat_especies;"
cursor1.execute(sql)
